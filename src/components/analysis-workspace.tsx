...
export function AnalysisWorkspace({ matchId }: { matchId: string }) {
  ...
  useEffect(() => {
    ...
    const measure = () => setSideHeight(desktop.matches ? Math.ceil(node.getBoundingClientRect().height) : 448);
  ...
  return <div className="space-y-4">
    ...
    <div className="analysis-layout grid items-start gap-4 min-[1120px]:grid-cols-[16rem_minmax(30rem,1fr)_19rem]">
